          ...
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
            <li id="storeNav">
              <a href="<?php echo base_url('Controller_Warehouse/') ?>">
                <i class="fa fa-institution"></i> <span>Supplier</span>
              </a>
            </li>
          <?php endif; ?>
...
/* Sidebar adjustments for 1360x768 screen */
.main-sidebar {
  width: 220px;
...
/* Sidebar collapse arrow adjustments */
.sidebar-menu .treeview > a .fa-angle-left {
  position: absolute;
  right: 15px;
}

/* Additional responsive adjustments for smaller screen height */

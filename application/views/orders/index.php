      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php endif ?>
            <?php if ($paid == 1): ?>
            <table id="paidTable" class="table table-bordered table-hover table-striped">
              <thead>
              <tr>
                <th>Bill No.</th>
                <th>Client</th>
            ...
            <?php endif ?>
            <?php if ($paid == 2): ?>
            <table id="unpaidTable" class="table table-bordered table-hover table-striped">
              <thead>
              <tr>
                <th>Bill No.</th>
                <th>Client</th>
...
$j(document).ready(function() {
  ...
  if (paid == 0) {
    console.log('Initializing manage table');
  ...
  if (paid == 1) {
    console.log('Initializing paid table');
    tableInitialized = true;
    $('#paidTable').dataTable({
      'ajax': base_url + 'Controller_Orders/fetchOrdersDataPaid',
      'order': []
    });
  } 

  if (paid == 2) {
    console.log('Initializing unpaid table');
    tableInitialized = true;
    $('#unpaidTable').dataTable({
      'ajax': base_url + 'Controller_Orders/fetchOrdersDataUnpaid',
      'order': []
    });
  } 
  ...
  if (!tableInitialized) {
    console.warn('No table initialized: unexpected value of paid:', paid);
  }

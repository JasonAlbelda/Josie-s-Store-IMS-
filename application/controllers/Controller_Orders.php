...
class Controller_Orders extends Admin_Controller 
{
	...
	*/
	...
	public function fetchOrdersDataPaid()
	{
		$result = array('data' => array());

		$data = $this->model_orders->getOrdersDataPaid();
	...
	public function fetchOrdersDataUnpaid()
	{
		$result = array('data' => array());

		$data = $this->model_orders->getOrdersDataUnpaid();
			  ...
			  <section class="invoice">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        ...
			        <b>Cashier/Customer:</b> '.$order_data['customer_name'].'<br>
